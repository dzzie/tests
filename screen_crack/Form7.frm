...
Private Sub BuildShards()
    ' v1 irregular tessellation: variable segments per ring (8/12/14/16/18),
    ' alternating apex-in / apex-out triangles for rings 1-4. This is the
    ' chaotic-looking pattern from the first version — there are intentional
    ' gaps and overlaps which give the shatter a natural-broken-glass feel
    ' rather than the geometric look of strict tessellation.
    ...
    For i = 0 To 4
        ...
        For j = 0 To segCount - 1
            ...
            If i = 0 Then
                ' Innermost ring: triangle with apex at center
                jitter = (Rnd - 0.5) * 15
            ...
            Else
                ' Outer rings: alternate apex-out / apex-in orientation per segment
                jitter = (Rnd - 0.5) * 20
                Dim aMid As Single
                aMid = (a1 + a2) * 0.5
                If (j Mod 2) = 0 Then
            ...
            ' Radiating-wave detach timing: map distance 0..600 -> frames 0..70.
            ' PHASE_SHATTER's FR_SHATTER cutoff (30) catches only inner shards;
            ' the rest stay attached, waiting for the fist.
            Dim base As Single
